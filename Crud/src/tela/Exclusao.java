...
public class Exclusao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o numero do ID do jogo que deseja excluir :");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        Jogos jogo = new Jogos();
          ...
          boolean j = jg.excluir(jogo);
          if (j) {
            JOptionPane.showMessageDialog(null, "O JOGO FOI DELETADO COM SUCESSO");

        } else {
              JOptionPane.showMessageDialog(null, "O JOGO NAO PÔDE SER DELETADO");
          }
